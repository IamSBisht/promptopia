    ...
    return (
        <nav className='flex-between w-full mb-16 pt-3'>
            <Link href="/" className='flex gap-2 flex-center'>
                <Image src="/assets/images/logo.svg" alt='Promtopia Logo' width="30" height="30" />
                ...
                {isUserLoggedIn ?
                    ...
                    <>
                        {providers && Object.values(providers).map((provider) => {
                            return <button type="button" key={provider.name} onClick={() => signIn(provider.id, { redirect: false })} className='black_btn'>
                                Sign In
                            </button>
                        }
                        )}
                    ...
                    <div className='flex'>
                        ...
                        {toggleDropdown &&
                            <div className='dropdown'>
                                ...
                                <Link href="/create_prompt" className='dropdown_link' onClick={() => setToggleDropdown(false)}>
                                    Create Prompt
                                </Link>
                                <button
                                    type="button"
